...
| 品鉴手记 | 七杯茶的记录，改 script 顶部 TEAS 数组：rating 填 0-5 数字，圆点自动渲染 |
| 联系我 | 邮箱、复制按钮、@MDL |

茶单在 `index.html` 的 script 顶部 TEAS 数组里改：rating 填 0-5 数字，圆点自动渲染；其余文案、联系方式搜对应文字定位；配色在 `:root` 的 CSS 变量里，改一处全页生效。
